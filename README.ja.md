...
v1.0.0-alpha.1 stabilization polish 時点で、Orange Hyper は新しい runtime feature を追加せず、v0.1 から v0.8 の Seed Kernel、Memory Proposal、Memory Graph Usability、read-only Identity Graph Preview、Minimal Hook Preview、MCP Advisor、Growth Signal Preview、Adapter Invocation Contract、local-only Eval and Reports の境界を再監査します。
