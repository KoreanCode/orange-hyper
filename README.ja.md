...
v0.8.0 stable 時点で、Orange Hyper は Seed Kernel、Memory Graph Usability、read-only Identity Graph Preview、Minimal Hook Preview、MCP Advisor stable、Growth Signal Preview stable、Adapter Invocation Contract stable、local-only Eval and Reports stable 機能を提供します。
