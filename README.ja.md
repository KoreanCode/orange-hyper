...
v0.6.0-alpha.0 時点で、Orange Hyper は Seed Kernel、Memory Graph Usability、read-only Identity Graph Preview、Minimal Hook Preview、MCP Advisor stable、Growth Signal Preview 機能を提供します。
...
- `growth status`、`growth suggest`、`growth explain` は Quest、Route、accepted Memory Graph、Hook warning、MCP advisor signal を読み、成長状態と候補を preview します。
