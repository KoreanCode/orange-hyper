...
v0.4.0-alpha.1 時点で、Orange Hyper は Seed Kernel、Memory Graph Usability、read-only Identity Graph Preview、Minimal Hook Preview 機能を提供します。
...
- ソース全体を TypeScript に移す作業は、v0.4 hook 作業の前後で別に進める予定です。
