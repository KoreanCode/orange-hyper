...
v0.4.0-alpha.1 기준으로 Orange Hyper는 Seed Kernel, Memory Graph Usability, read-only Identity Graph Preview, Minimal Hook Preview 기능을 제공합니다.
...
npx -y --package orange-hyper@alpha orange hook preview --json
```
